...
class VideoWithVoxelTruthDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit VideoWithVoxelTruthDataLayer(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~VideoWithVoxelTruthDataLayer();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "VideoWithVoxelTruthData"; }

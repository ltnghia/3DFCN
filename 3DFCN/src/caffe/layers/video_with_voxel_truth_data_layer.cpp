...
#include "caffe/layers/video_with_voxel_truth_data_layer.hpp"
...
template <typename Dtype>
void VideoWithVoxelTruthDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void VideoWithVoxelTruthDataLayer<Dtype>::ShuffleClips() {
...
template <typename Dtype>
void VideoWithVoxelTruthDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
REGISTER_LAYER_CLASS(VideoWithVoxelTruthData);
